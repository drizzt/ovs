...
/* Weak stub for the DPDK offload class.  Zero-initialized so that
 * dpif_offload_module_init() can detect it via .type == NULL and skip
 * registration.  When ovs-vswitchd links libopenvswitchdpdk.a, the
 * strong definition from dpif-offload-dpdk.o overrides this stub. */
OVS_WEAK struct dpif_offload_class dpif_offload_dpdk_class;
